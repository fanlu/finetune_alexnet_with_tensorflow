...
def train():
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope("cross_ent"):
            loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=score, labels=labels))
        print(1.5)
        # Train op
        ...
        sv = tf.train.Supervisor(logdir="/Users/lonica/finetune_alexnet/supervisor", init_op=tf.group(tf.global_variables_initializer(), tf.local_variables_initializer()))
